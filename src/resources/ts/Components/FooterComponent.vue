...
const navigation = [
    {
        ...
        rows: [
            'Via nazionale n°32, 36040 Vancimuglio (VI)',
            'Tel: +390444022349',
            'Mobile: +393292983245',
            'Mail: info@capricciosapizzerie.it'
        ]
    },
    {
        name: "Opening hours",
...
<template>
    ...
    <footer class="footer p-10 bg-white text-base-content my-24">
        <aside class="max-sm:mx-auto ">
            ...
            <p class="text-gray-500 w-full max-sm:text-center hidden md:block">Capricciosa Pizzeria srl<br>P.IVA 01223580554</p>
        </aside>
