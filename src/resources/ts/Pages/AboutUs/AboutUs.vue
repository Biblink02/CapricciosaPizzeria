...
<AppLayout :title="$t('Menus')" :footer="page.footer">
    ...
    <p class="font-[AwakeTheBeauty] md:text-4xl sm:text-lg mx-auto my-8">{{ $t('Capricciosa in taste and design') }}</p>
