...
<template>
    <AppLayout :title="$t('Menus')" :footer="page.footer">
        <p
            class="mx-auto my-8 text-justify text-4xl md:text-6xl sacramento-regular"
        >
            {{ $t('Capricciosa in taste and design') }}
        </p>
        <p
            class="text-gray-500 text-justify md:text-lg mb-3 w-5/6 mx-auto lg:max-w-4xl md:max-w-3xl"
        >
            {{
                $t(
        ...
        <p
            class="text-gray-500 text-justify md:text-lg w-5/6 mx-auto lg:max-w-4xl md:max-w-3xl"
        >
            {{
                $t(
